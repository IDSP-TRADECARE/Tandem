      ...
      <div className="flex-1 pb-32">
        {step === 'select' && (
          <div className="px-4 pt-6">
            {/* Tab Navigation */}
            <div className="flex gap-0 mb-8 bg-white border-2 border-[#1e3a5f] rounded-full p-1">
              <button
            ...
            {inputMethod === 'file' && (
              <div>
                ...
                <p className="text-gray-600 mb-8">
                  Upload your schedule here, and our AI will take care of your work and childcare planning for you!
                </p>
            ...
            <div className="bg-white rounded-lg p-6">
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full py-3 px-4 bg-[#1e3a5f] text-white font-semibold rounded-lg hover:bg-[#2d4a6f] transition-colors"
                >
                  View Overview
                </button>
                <button
