      ...
      <div className="flex-1 pb-32">
        {step === 'select' && (
          <div className="px-4 pt-6">
            ...
            {/* Voice Input Button */}
            <div className="fixed bottom-32 left-1/2 -translate-x-1/2 flex flex-col items-center z-40">
              <button
                onClick={() => handleMethodSelect('voice')}
                className="w-16 h-16 bg-blue-500 rounded-full shadow-xl flex items-center justify-center hover:scale-105 transition-transform mb-2"
              >
